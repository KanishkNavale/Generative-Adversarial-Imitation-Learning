...
class DuelingDeepQNetwork(keras.Model):
    def __init__(self, n_actions):
        ...
        self.fc2 = Dense(32, activation='relu', name='fc2')
        self.V = keras.layers.Dense(1, activation=None, name='V')
        self.A = keras.layers.Dense(n_actions, activation=None, name='A')
...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size,
        ...
        self.q_eval = DuelingDeepQNetwork(n_actions)
        self.q_next = DuelingDeepQNetwork(n_actions)
